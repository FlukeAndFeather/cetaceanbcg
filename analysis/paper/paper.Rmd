...
prh_10hz <- readRDS(here::here("analysis/data/derived_data/prh_10hz.rds")) %>% 
  mutate(jerk_smooth = tma(prh_10hz$jerk, window * 10))
```
...
acc_400hz$bcg_beat <- find_beats(acc_400hz$surge_filt, window, fs)

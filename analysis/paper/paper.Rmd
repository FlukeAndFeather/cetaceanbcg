...
```{r corky-bcg-ecg, fig.cap="A: BCG, B: ECG, C: BPM comparison"}
# A: Surge + LSR
...
# C: Jerk
pC <- ggplot(bcg_sample_10hz, aes(dt, jerk_smooth)) +
  geom_line(size = 0.2) +
...
Figure \@ref(fig:corky-bcg-ecg) shows how we can have a caption and cross-reference for a plot.
